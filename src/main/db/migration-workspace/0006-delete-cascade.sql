...
-- Rebuild queue_membership table with ON UPDATE CASCADE and ON DELETE CASCADE on file foreign key
...
CREATE TABLE queue_membership (
    ...
    REFERENCES file(library_id, relative_path) ON UPDATE CASCADE ON DELETE CASCADE,
